...
list1 = ["Gray","Sam","Merrick","Jackson","Brooks","Manny","Callie","Paige","Chris","Ace","Jeremiah","James"]
print(list1)
...
def random_number():
	...
	lucky_friend["text"] = "Your Lucky Best Friend Is: " + str(genrated_random_number)
